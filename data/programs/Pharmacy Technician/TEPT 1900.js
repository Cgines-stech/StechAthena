...
const TEPT1900 = [
  {
    ...
    courseAssignmentsandAsssessments: [
      ...
      "PTCE Out line",
      "STAR Interviews",
      "Helpful R,eview Guides",
      "PTCE Practice Tools",
      "NEW - PTCE Practice Exam",
      "STECH TIME SHEET - Time sheet.pdf",
      "Google Drive Link - Timesheet",
      "UT DOPL License",
      "Look into, Continuing Education Programs",
      "Blood Borne Pathogens Training",
      "Combatirng Medicare Parts C & D: Fraud, Waste, & Abuse Training",
      "HIPAA Training",
      "Pre-Externship Evaluation",
      "Completed Module 1 - TEPT 1900",
      ...
      "PTCE #1",
      "Site 1 - Pharmacy Preceptor Evall!Jation of the Student",
      "Site 1 - Student Evaluation of the Externship Site",
      "Completed Module 2 - TEPT 1900",
      ...
      "Post Externship Evaluation",
      "Completed Module 3 - TEPT 1900",
