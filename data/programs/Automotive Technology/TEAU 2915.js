...
const TEAU2915 = [
  {
    id: 30018,
    programId: 3,
    courseNumber: "TEAU 2915",
    courseName: "Manufacturer Automotive Service Training - Mercedes-Benz",
    courseCredits: 2,
    ...
    courseDescription:
      "MB Campus provides next-level vehicle technology, service, and repair. This program provides exposure to MB technologies and products, provides a skill-set for MB success, and improves earning potential as an MB intern.",
