...
const TEPA1000 = [
  {
    ...
    courseDescription:
      "This course prepares the student to enter the paramedic program with the assurance that they have an essential basis in anatomy, physiology, English and math to be successful in the program.",

    courseObjectives: [
      "Execute clear, concise, and professional written communication.",
      "Accurately execute essential foundational math skills.",
      "Thoroughly explain general anatomy and physiology in relation foundational concepts requisite to pursue paramedic education.",
      "Demonstrate foundational knowledge, preparation, and readiness to enter the paramedic program.",
    ],

    courseOutline: [
      { title: "Anatomy", hours: 8},
      { title: "Physiology", hours: 8},
      { title: "English", hours: 7},
      { title: "Math", hours: 7},
    ],
