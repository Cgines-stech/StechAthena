...
export default [
  {
    title: "",
    content: [
      "Course Grading: EACH exam score must be 75% or higher, all skills must be passed off at 100%, and an overall grade of 80% must be maintained in order to attend clinical rotations, pass the course, and be approved to sit for the state certification exam. Any grade below a B- is considered failing the course.",
