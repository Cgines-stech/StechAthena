...
export default [
  {
    title: "",
    content: [
      "Course Grading: Chapter tests may be attempted up to THREE times and will remain open until the posted due date. Each exam must be passed with a minimum of 80%. If quizzes are attempted multiple times, the highest score will be saved. If exams and all other graded metrics do not meet the minimum required score of 80%, the student will not be recommended for testing and the awarded grade will present as F.",
