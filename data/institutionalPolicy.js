...
export default [
  {
    ...
    content: [
      ...
      `Safety and Building Maintenance: The College has developed and follows a variety of plans to ensure the safe and effective operation of its facilities and programs. The following plans are available online:<br>1) Facilities Operations and Maintenance Plan; 2) Technical Infrastructure Plan; and 3) Health and Safety Plan.<br>`,
      `Withdrawals and Refunds: Please refer to the Southwest Technical College Refund Policy at: <a href="https://stech.edu/students/policies/">https://stech.edu/students/policies/</a><br>`,
      `Any high school or adult student, who declares a technical training objective is eligible for admission at Southwest Technical College (Southwest Tech). Program-specific admissions requirements may exist and will be listed on the Southwest Tech website. A high school diploma or equivalent is not required for admission but is mandatory for students seeking Title IV Federal Financial Aid.<br>`,
